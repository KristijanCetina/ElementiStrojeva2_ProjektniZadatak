...
\newcommand{\naslovRada}{Projektni zadatak\\\textit{-radna verzija-}}
...
\section*{ToDo list}
\begin{itemize}
\item Prepraviti proračun zbog povećanja $d_2$ [\hspace{10pt}]
\item Napraviti i baciti skice detalja korištenih prilikom izračuna [\hspace{10pt}]
\item Napisati uvod i zaključak zadatka [\hspace{10pt}]
\item proofread i ispraviti greške i tipflere [\hspace{10pt}]
\end{itemize}
\newpage
\section{Uvod}
...
$$
\sigma_{s1}=\frac{M_{S1}}{W_1}=\frac{24624,9}{6283,2}=\mathbf{3,9\textstyle\frac{N}{mm^2}}
$$
\subsubsection*{presjek 2-2}
\begin{align*}
\sigma_{s2}=\frac{M_{S2}}{W_2}=\frac{61562,3}{10192,8}&=6\textstyle\frac{N}{mm^2}\\
\tau_{t2} =\frac{T}{W_{p2}}=\frac{274,5 \cdot 10^3}{20385,6}&=13,5\textstyle\frac{N}{mm^2}\\
\sigma_{ekv2}=\sqrt{\sigma_{s2}^2+3 \cdot (0,7 \cdot \tau_{t2})^2}\\
\sigma_{ekv2}=\sqrt{6^2+3 \cdot (0,7 \cdot 13,5)^2}&=\mathbf{17,5\textstyle\frac{N}{mm^2}}
\end{align*}
\subsubsection*{presjek 3-3}
\begin{align*}
\sigma_{s3}=\frac{M_{S3}}{W_3}=\frac{70815,3}{10192,8}&=7\textstyle\frac{N}{mm^2}\\
\tau_{t3} =\frac{T}{W_{p3}}=\frac{274,5 \cdot 10^3}{20385,6}&=13,5\textstyle\frac{N}{mm^2}\\
\sigma_{ekv3}=\sqrt{\sigma_{s3}^2+3 \cdot (0,7 \cdot \tau_{t3})^2}\\
\sigma_{ekv3}=\sqrt{7^2+3 \cdot (0,7 \cdot 13,5)^2}&=\mathbf{17,8 \textstyle \frac{N}{mm^2}}
\end{align*}
\subsubsection*{presjek 4-4}
\begin{align*}
\sigma_{s4}=\frac{M_{S4}}{W_4}=\frac{23175,9}{12566,4}&=1,8\textstyle\frac{N}{mm^2}\\
\tau_{t4} =\frac{T}{W_{p4}}=\frac{274,5 \cdot 10^3}{6283,2}&=3,7\textstyle\frac{N}{mm^2}\\
\sigma_{ekv4}=\sqrt{\sigma_{s4}^2+3 \cdot (0,7 \cdot \tau_{t4})^2}\\
\sigma_{ekv4}=\sqrt{3,7^2+3 \cdot (0,7 \cdot 21,9)^2}&=\mathbf{26,8 \textstyle\frac{N}{mm^2}}
\end{align*}
\subsubsection*{presjek 5-5}
$$
\tau_{t5} =\frac{T}{W_{p4}}=\frac{274,5 \cdot 10^3}{7056,2}=\mathbf{38,9\textstyle\frac{N}{mm^2}}
$$
...
\subsubsection*{presjeci 1-1 i 4-4}
U pogledu konstrukcijskih karakteristika i naprezanaja presjeke 1-1 i 4-4 mogu se smatrati jednakima te je stoga i njihovo dopušteno naprezanje jednako. Zakrivljenost žlijeba za izlaz alata je $\rho_1=0,6mm$, vrijednost geometrijskog faktora koncentracije naprezanja pri savijanju je očitana $\alpha_{ks}=3$ i faktor utjecaja veličine konstrukcijskog elementa je $d_2=40mm \Rightarrow b_2=0,85$.
...
\begin{align*}
\sigma_{dop}&=\frac{370 \cdot 0,939 \cdot 0,85}{1,3 \cdot 2,47}\\
\sigma_{dop}&=\mathbf{92\textstyle\frac{N}{mm^2}}
\end{align*}
...
\subsubsection*{presjeci 2-2 i 3-3}
Za dane presjeke $d_3=47mm \Rightarrow b_2=0,829$, zakrivljenje $\rho=5mm$ i $\alpha_{ks}=1,8$.
...
\begin{align*}
\sigma_{dop}&=\frac{370 \cdot 0,939 \cdot 0,829}{1,3 \cdot 1,76}\\
\sigma_{dop}&=\mathbf{125,5\textstyle\frac{N}{mm^2}}
\end{align*}
Vidljivo je kako dopušteno naprezanje iznosi više od ekvivalentnih naprezanja koji se javljaju u danim presjecima te da oni zadovoljavaju kriterij čvrstoće.
...
\begin{align*}
\tau_{dop}&=\frac{340 \cdot 0,965 \cdot 0,856}{1,3 \cdot 1,97}\\
\tau_{dop}&=\mathbf{109,7\textstyle\frac{N}{mm^2}}
\end{align*}
